...
data_dir = Path("/root/autodl-tmp/fake_detect", "M2F")
...
gt_indices = np.random.choice(*np.where(speakers == "real"), 4, replace=False) 
# gt_indices = [1]
print(gt_indices)
...
plt.axhline(0.85, ls="dashed", label="Prediction threshold", c="black")
...
plt.legend()
plt.xticks(indices, names, rotation=30, ha="right", fontsize=10)
# plt.xlabel("M2F")
plt.ylim(0.6, 1.0)
